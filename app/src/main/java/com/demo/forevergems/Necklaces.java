...
public class Necklaces extends AppCompatActivity {
    ...
    private Spinner spinnerNecklace, spinnerGem;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NecklaceMaterial.initNecklaceMaterial();
        spinnerNecklace = (Spinner) findViewById(R.id.spinnerNecklaceMaterial);

        SpinnerAdapter customAdapter = new NecklaceSpinnerAdapter(this, R.layout.custom_ring_spinner_adapter, NecklaceMaterial.getNecklaceMaterialArrayList());
        spinnerNecklace.setAdapter(customAdapter);
