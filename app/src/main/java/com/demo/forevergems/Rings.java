...
public class Rings extends AppCompatActivity {
    ...
    private Spinner spinnerRing, spinnerGem;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RingMaterial.initRingMaterial();
        spinnerRing = (Spinner) findViewById(R.id.spinnerRingMaterial);

        SpinnerAdapter customAdapter = new RingSpinnerAdapter(this, R.layout.custom_ring_spinner_adapter, RingMaterial.getRingMaterialArrayList());
        spinnerRing.setAdapter(customAdapter);
